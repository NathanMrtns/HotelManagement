...
if ( $_SERVER[ 'REQUEST_METHOD' ] == 'POST' )
{
  ...
  { $errors[] = 'Enter your zip code.'; }
  else
  { $zip = mysqli_real_escape_string( $dbc, trim( $_POST[ 'zip_code' ] ) ) ; }
		...
		<div class="col-md-12 column">
			...
			<form class="form-horizontal" role="form" action="register.php" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputAddress3" placeholder="Enter your address" name="address">
					</div>
				</div>
				<div class="form-group">
					 <label for="inputZipCode3" class="col-sm-2 control-label" >Zip Code</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputZipCode3" placeholder="Enter your Zip Code" name="zip_code" >
					</div>
				</div>
				<div class="form-group">
